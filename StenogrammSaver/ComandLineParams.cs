...
Использование:
    StenogrammSaver [/s|/server=<имя сервера>][/ia|/intauth | /u|/user"+strDelimiter+@"<имя пользователя> /p|/password"+strDelimiter+@"<пароль>]
					[/od|/outdir"+strDelimiter+@"<путь к директории>]
